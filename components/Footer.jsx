    ...
    <footer className="footer">
      ...
      <div className="container footer-inner">
        ...
        >
          ...
          <div className="footer-social" style={{ display: 'flex', gap: '1.25rem', marginTop: '1.5rem', justifyContent: 'center' }}>
            {hasSocial(settings?.socialFacebook) && (
              <a href={fixUrl(settings.socialFacebook)} target="_blank" rel="noopener noreferrer" className="social-icon-link" aria-label="Facebook">
